...
import ch.makery.address.GothenburgHotels;
...
public class HotelOverviewController {
	...
	private GothenburgHotels GothenburgHotels;
...
private void handleNewHotel() {
	...
	boolean okClicked = GothenburgHotels.showHotelEditDialog(tempHotel);
	if (okClicked) {
		GothenburgHotels.getHotelData().add(tempHotel);
	}
}
...
private void handleEditHotel() {
	...
	if (selectedHotel != null) {
		boolean okClicked = GothenburgHotels.showHotelEditDialog(selectedHotel);
		if (okClicked) {
		...
		alert.initOwner(GothenburgHotels.getPrimaryStage());
...
public void setGothenburgHotels(GothenburgHotels GothenburgHotels) {
	this.GothenburgHotels = GothenburgHotels;
